 ...
 * @LastEditTime: 2021-10-26 19:29:23
...
// 行数
export const gameRow = width > 700 ? Math.floor(height / 74) : Math.floor(height / 34);

// 列数
export const gameCol = width > 700 ? Math.floor(width / 74) : Math.floor(width / 34);
